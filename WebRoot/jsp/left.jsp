...
<body style="background: #f0f9fd;">
	...
	<dl class="leftmenu">
			...
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='DD'}">
						...
						<li><cite></cite> <a href="${queryInst}" target="rightFrame">管理员管理</a>
							<i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
				...
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='DD'}">
						<li><cite></cite> <a href="imgtable.html" target="rightFrame">角色管理</a>
							<i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='DD'}">
						<li><cite></cite> <a href="form.html" target="rightFrame">角色授权</a>
							<i></i></li>
					</c:if>
				</c:forEach>
			</ul>
		...
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico03.png" /></span>消息管理
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
		...
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>理财产品管理
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${queryFinanceP}"
							target="rightFrame">查看理财产品</a><i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${toaddFinanceP}"
							target="rightFrame">添加理财产品</a><i></i></li>
					</c:if>
				</c:forEach>
			</ul>
		...
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>充值管理
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
		...
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>提现管理
			</div>
			<ul class="menuson">
				...
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${queryOutMoney}"
							target="rightFrame">主账户提现申请</a><i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						<c:url value="/pt/doWithdrawMain" var="queryOutMoney">
							<c:param name="tag" value="query" />
							<c:param name="pageNum" value="1" />
						</c:url>
						<li><cite></cite><a href="${queryOutMoney}"
							target="rightFrame">子账户提现申请</a><i></i></li>
					</c:if>
				</c:forEach>
			</ul>
		</dd>
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>积分商城管理
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${queryCommodityList}"
							target="rightFrame">查看商品</a><i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
				...
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${queryOrderList}"
							target="rightFrame">查看订单</a><i></i></li>
					</c:if>
				</c:forEach>
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
				...
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
						...
						<li><cite></cite><a href="${queryIntegralList}"
							target="rightFrame">查看积分明细</a><i></i></li>
					</c:if>
				</c:forEach>
			</ul>
		</dd>
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>积分汇率管理
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
		...
		<dd>
			<div class="title">
				<span><img src="jsp/images/leftico04.png" /></span>子账户
			</div>
			<ul class="menuson">
				<c:forEach items="${sessionScope.rightList}" var="right">
					<c:if test="${right=='AA'}">
