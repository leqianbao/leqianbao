...
<ul class="seachform">
    <li><label>姓名</label><input name="name" type="text"  value="${name }" class="scinput" /></li>
    <li><label>手机号</label><input name="phone" type="text"  value="${phone }" class="scinput" /></li>
       ...
       <!--  <th><input name="" type="checkbox" value="" checked="checked"/></th> -->
		...
		<c:forEach items="${result.data_list }" var="user">
						<tr>
							...
							<td>
								<c:if test="${user.is_verify eq 0}">未认证</c:if>
